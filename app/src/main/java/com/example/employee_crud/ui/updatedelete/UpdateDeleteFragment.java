...
public class UpdateDeleteFragment extends Fragment {
    ...
    private EditText etEmpName, etAge, etSalary, etState, etCountry, etZipCode;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        etState = root.findViewById(R.id.etState);
        etCountry = root.findViewById(R.id.etCountry);
        etZipCode = root.findViewById(R.id.etZipCode);
    ...
    private void loadData()
    {
        ...
        listCall.enqueue(new Callback<Employee>() {
            ...
            public void onResponse(Call<Employee> call, Response<Employee> response) {
                ...
                etState.setText(response.body().getEmployee_state());
                etCountry.setText(response.body().getEmployee_country());
                etZipCode.setText(response.body().getEmployee_zipcode());
